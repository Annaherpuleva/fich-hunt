...
const TERMS_TEXT = {
  ru: {
    ...
    s1_intro: 'Используя сайт и смарт-контракт HODL HUNT, вы подтверждаете, что:',
    s1_list: [
    ...
    s4_title: '4. Смарт-контракт',
    s4_p1: 'Все игровые действия выполняются исключительно через смарт-контракт.',
    s4_p2: 'Контракт работает по принципу “as is” (как есть).',
    s4_p3: 'Мы не можем вмешиваться в его логику.',
    s4_p4: 'Транзакции необратимы.',
    s4_p5:
      'Пользователь понимает, что любые взаимодействия с блокчейном несут технические и финансовые риски.',
    ...
    s7_p1: 'Это не влияет на уже совершённые ончейн-операции.',
  ...
  en: {
    ...
    s1_intro:
      'By accessing or interacting with the HODL HUNT website or smart contract, you confirm that you:',
    s1_list: [
    ...
    s2_list: [
      'a strategic PvP blockchain-based game',
    ...
    s4_title: '4. Smart Contract Operation',
    s4_p1: 'All game interactions occur exclusively via a smart contract.',
    s4_p2: 'The smart contract operates on an “as is” basis.',
    s4_p3: 'Transactions are irreversible.',
    s4_p4: 'The team cannot alter outcomes or interfere with contract logic.',
    s4_p5: 'Users acknowledge the inherent risks of interacting with blockchain technology.',
    ...
    s7_p1: 'This does not affect already executed on-chain transactions.',
